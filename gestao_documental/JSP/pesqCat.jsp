<%-- 
    Document   : pesqCat
    Created on : 30/01/2026, 16:42:22
...
<html>
    ...
    <body>
         ...
         <%
            ...
            try {
                ...
                if (acao.equals("pesquisar")){
                    ...
                    %>
                    <h3>Pesquisa de <b><i><%= texto %></i></b> nas categorias</h3>
                ...
                try{
                        ...
                        ResultSet rs = stmt.executeQuery("SELECT * FROM tCategoria WHERE categoria LIKE '%"+texto+"%'");
                        while(rs.next()){
                        %>
                        <tr>
                            <td><%= rs.getInt("id") %></td>
                            ...
                            <td>
                        <form method="post" action="pesqCat.jsp">
        ...
        <form method="post" action="pesqCat.jsp">
            ...
            <label>Categoria:<input type="text" name="texto"></label>
